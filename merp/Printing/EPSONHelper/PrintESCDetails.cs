...
{
	public class PrintESCDetails:PrintESCPSBase
	{
		double _ttltax;
		double _ttlAmt;
		int ttlline;
		...
		public List<string> GetPrintCNNote(CNNote inv,CNNoteDtls[] invdtls)
		{
			List<string> text = new List<string>();
			ttlline = 0;
			_ttltax =0;
		...
		public void PrintSmallLine (Stream mmOutputStream,string line)
		{
